    ...
    <section id="main-content">
        <section class="wrapper">
            ...
            if (isset($_POST['pr_sample_edit']))
            {
                ...
                $pr_sample_row = $_POST['pr_sample_row'];

                unlink($image_nav);
                $DB->query("UPDATE product_sample SET location = ?, title = ?, text = ? WHERE id = ?",
                    array("$location", "$title", "$text", "$pr_sample_row"));
                echo "Succes edit";
                        ...
                        <div class="panel-body">
                            <div class="padd">
                                ...
                                <div class="form quick-post">
                                    ...
                                    <?php $result = $DB->query("SELECT * FROM product_sample WHERE id=?",array("$id"));
                                    foreach ($result as $row):
                                        ...
                                        <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-lg-2" for="title">Описание</label>
                                                <div class="col-lg-10">
                                                    <input type="text" name="text" value="<?php echo $row['text']?>" class="form-control" id="title">
                                                </div>
                                            </div>
                                            <input type="hidden" name="pr_sample_row" value="<?php echo $row['id']?>">
                                            <!-- Buttons -->
                                            <div class="form-group">
                                                <!-- Buttons -->
                                                <div class="col-lg-offset-2 col-lg-9">
                                                    <button type="submit" name="pr_sample_edit" class="btn btn-success">Сохранить</button>
